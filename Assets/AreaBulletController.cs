...
public class AreaBulletController : MonoBehaviour {
    ...
    void Start()
    {
        ...
        bullet1.transform.forward = Vector3.up;
        ...
        bullet2.transform.forward = (Vector3.up + Vector3.right).normalized;
        ...
        bullet4.transform.forward = (Vector3.right + Vector3.down).normalized;
        ...
        bullet5.transform.forward = Vector3.down;
        ...
        bullet6.transform.forward = (Vector3.down + Vector3.left).normalized;
        ...
        bullet8.transform.forward = (Vector3.left + Vector3.up).normalized;
